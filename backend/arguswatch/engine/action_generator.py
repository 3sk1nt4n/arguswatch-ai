...
async def generate_action(finding_id: int, db: AsyncSession) -> FindingRemediation | None:
    ...
    playbook_key = (
        CORRELATION_TO_PLAYBOOK.get(finding.correlation_type or "") or
        IOC_TO_PLAYBOOK.get(finding.ioc_type, "generic")
    )
    ...
    remediation = FindingRemediation(
        ...
        title=_title(playbook_key, ctx),
        steps_technical=steps_tech,
