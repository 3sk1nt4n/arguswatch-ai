...
#   5. main.py lifespan: 30+ ALTER TABLE → seeds 6 customers from CSV
...
echo "    ollama ........... Downloading qwen2.5:14b (~9GB first time)"
...
echo "    2. Seed 6 customers (Yahoo, Shopify, Uber, GitHub, Starbucks, VulnWeb)"
